...
function setupPuzzle(){
   ...
   for(var i = 0; i<allCells.length; i++){
      ...
      allCells[i].addEventListener("mouseover", function(e){
         // holding a key will display a picture for the cursor corisponding to what it does
         if(e.shiftKey){
...
function findErrors(){
   // this will find the errors and make them have a pink font color for 1 second
   for(var i = 0; i<allCells.length; i++){
   ...
   setTimeout(function(){
      ...
      // this will make the pink font color last for only 1 second
   }, 1000)
}
